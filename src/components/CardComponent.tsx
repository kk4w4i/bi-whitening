    ...
    <div>
      <div className={`flex mt-8 -space-x-10 h-[20rem] w-[110%]`}>
        <Dialog>
          ...
          <DialogContent className="flex rounded-lg h-fit w-[90vw] md:h-auto md:w-auto overflow-x-clip overflow-y-auto">
        ...
        <Dialog>
          ...
          <DialogContent className="flex rounded-lg h-fit w-[90vw] md:h-auto md:w-auto overflow-clip">
            <VisuallyHidden.Root asChild>
              <DialogTitle />
            </VisuallyHidden.Root>
            <DialogDescription />
